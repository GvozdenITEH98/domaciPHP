...
if (isset($_POST['dodaj-automobil'])) {
  $erros = [];
  $values = [];
  ...
  if (count($erros) == 0) {
    ...
    $db->insert("automobili", "marka, naziv, kubikaza, konjaza, kilometraza, img, godina, opis, cena, polovan, gorivo", $values);
...
<section id="dodaj-automobil" class="my-5">
  <div class="container">
    <h1 class="text-center mb-5">DODAJ AUTOMOBIL
      <hr>
    </h1>
      ...
      <div class="col-md-6 col-sm-6 offset-md-3 offset-sm-3">
        <form method="POST">
          ...
          <fieldset class="form-group">
            ...
            <div class="form-check">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" name="gorivo" value="BENZIN" <?php if (isset($gorivo) && $gorivo == "BENZIN") echo "CHECKED"; ?>>
                BENZIN
              </label>
            </div>
            <div class="form-check">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" name="gorivo" value="DIZEL" <?php if (isset($gorivo) && $gorivo == "DIZEL") echo "CHECKED"; ?>>
                DIZEL
              </label>
            </div>
          </fieldset>

          <button type="submit" name="dodaj-automobil" class="btn btn-primary w-100">DODAJ AUTOMOBIL</button>
